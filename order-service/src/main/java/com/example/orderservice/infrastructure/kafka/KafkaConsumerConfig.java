...
/**
 * Configures Kafka listeners with retries and DLT. After max attempts,
 * the record is sent to the topic's .dlt and the offset is committed so we don't block the partition.
 */
@Configuration
